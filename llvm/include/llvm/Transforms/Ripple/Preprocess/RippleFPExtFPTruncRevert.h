...
#ifndef LLVM_TRANSFORMS_VECTORIZE_RIPPLE_FPEXT_FPTRUNC_REVERT_H
#define LLVM_TRANSFORMS_VECTORIZE_RIPPLE_FPEXT_FPTRUNC_REVERT_H
...
#endif // LLVM_TRANSFORMS_VECTORIZE_RIPPLE_FPEXT_FPTRUNC_REVERT_H
