...
declare i32 @llvm.ripple.slice.i32(i32, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg, i64 immarg)
declare i32 @printf(...)
...
merge:
  ...
  %s = call i32 @llvm.ripple.slice.i32(i32 %v, i64 2, i64 0, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1, i64 -1)
  %p = call i32 (...) @printf(i32 %s)
  br label %latch

; CHECK-COUNT-1:         call i32 @llvm.ripple.slice.i32
