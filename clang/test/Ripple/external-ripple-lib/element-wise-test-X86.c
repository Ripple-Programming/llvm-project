...
// RUN: %clang --target=x86_64-unknown-elf -g -c -O2 -fenable-ripple -emit-llvm %S/external_library.c -o %t.rlib.bc
// RUN: %clang --target=x86_64-unknown-elf -O2 -fenable-ripple -fripple-lib=%t.rlib.bc -emit-llvm -S -o - -mllvm -ripple-disable-link %s | FileCheck %s
...
// CHECK: store <32 x float> [[Extract1_quarter_1]], ptr [[VecStoreLhs:%.*]], align 128
// CHECK: store <32 x float> [[Extract2_quarter_1]], ptr [[VecStoreRhs:%.*]], align 128
// CHECK: tail call void @ripple_ew_side_effect_no_return(ptr nonnull [[VecStoreLhs]], ptr nonnull [[VecStoreRhs]])
...
// CHECK: store <32 x float> [[Extract1_quarter_2]], ptr [[VecStoreLhs:%.*]], align 128
// CHECK: store <32 x float> [[Extract2_quarter_2]], ptr [[VecStoreRhs:%.*]], align 128
// CHECK: tail call void @ripple_ew_side_effect_no_return(ptr nonnull [[VecStoreLhs]], ptr nonnull [[VecStoreRhs]])
...
// CHECK: store <32 x float> [[Extract1_quarter_3]], ptr [[VecStoreLhs:%.*]], align 128
// CHECK: store <32 x float> [[Extract2_quarter_3]], ptr [[VecStoreRhs:%.*]], align 128
// CHECK: tail call void @ripple_ew_side_effect_no_return(ptr nonnull [[VecStoreLhs]], ptr nonnull [[VecStoreRhs]])
...
// CHECK: store <32 x float> [[Extract1_quarter_4]], ptr [[VecStoreLhs:%.*]], align 128
// CHECK: store <32 x float> [[Extract2_quarter_4]], ptr [[VecStoreRhs:%.*]], align 128
// CHECK: tail call void @ripple_ew_side_effect_no_return(ptr nonnull [[VecStoreLhs]], ptr nonnull [[VecStoreRhs]])
