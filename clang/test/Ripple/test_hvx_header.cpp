...
// RUN: %clang --target=hexagon-unknown-elf -mv79 -mhvx %s -O2 -fenable-ripple -ffreestanding -nostdinc -isystem %resource_dir/ripple_include -isystem %resource_dir -S -emit-llvm -o - | FileCheck %s
// RUN: %clang --target=hexagon-unknown-elf -mv79 -mhvx -x c %s -O2 -fenable-ripple -ffreestanding -nostdinc -isystem %resource_dir/ripple_include -isystem %resource_dir -S -emit-llvm -o - -D__hexagon__=1 | FileCheck %s
